...
@Component({
  selector: 'app-agent-insurance',
  templateUrl: './agent-insurance.component.html',
  styleUrls: ['./agent-insurance.component.css']
})
export class AgentInsuranceComponent {
  planId: any
  ...
  getCustomerProfle() {
    ...
    this.customer.getUserDetailsByCustomerId(this.customerId).subscribe({
      next: (res) => {
